document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    en: {
      ...
      faqs_q1: "MAY I BRING MY CHILDREN?",
      faqs_a1: "To give all our guests the opportunity to celebrate without having to worry about little eyes and ears, we respectfully request no children. This is an 18+ event. We appreciate your understanding and look forward to celebrating with you!",
      faqs_q2: "IS THERE A DRESS CODE?",
      faqs_a2: "We ask that our guests dress in Formal Attire. We recommend suits or blazers for men and floor-length dresses for women. We kindly ask that you refrain from wearing white, ivory, cream, beige, or similar light colors. Please, no sneakers.",
      faqs_q3: "WHEN SHOULD I RSVP BY?",
      faqs_a3: "We ask that all guests submit their RSVPs no later than October 31st, 2026, to ensure we have an accurate headcount for our vendors.",
      faqs_q4: "ARE PLUS-ONES ALLOWED?",
      faqs_a4: "Due to space limitations and an intimate celebration with close family, we can only accommodate those listed on your formal invitation. Please refer to your invitation for the specific number of seats reserved in your honor. We can't wait to celebrate this special day with our closest family and friends!",
      faqs_q5: "HOW CAN I SHARE THE PICTURES AND VIDEOS I TAKE?",
      faqs_a5_before: "We would love to see the night through your eyes! Please use this link to add your photos and videos to our shared album: ",
      faqs_a5_link: "Google Photos Link",
      faqs_q6: "WHAT IS YOUR WEDDING HASHTAG?",
      faqs_a6: "Feel free to use #MataCorbeira when posting on social media!",
      faqs_q7: "IS THERE A WEDDING REGISTRY?",
      faqs_a7_before: "If you wish to honor us with a gift, you can find our registry here: ",
      faqs_a7_link1: "Amazon Wedding Registry",
      faqs_a7_middle: ". For monetary gifts, we also accept Zelle at +1 (954) 918-8129. Please see the ",
      faqs_a7_link2: "Gifts",
    ...
    es: {
      ...
      faqs_kicker: "Preguntas",
      faqs_title: "Preguntas Frecuentes",
      faqs_q1: "¿PUEDO TRAER A MIS HIJOS?",
      faqs_a1: "Para que todos nuestros invitados puedan celebrar sin preocupaciones, pedimos respetuosamente que no se traigan niños. Este es un evento para mayores de 18 años. ¡Apreciamos su comprensión y esperamos celebrar con ustedes!",
      faqs_q2: "¿HAY CÓDIGO DE VESTIMENTA?",
      faqs_a2: "Pedimos a nuestros invitados que vistan de Etiqueta Formal. Recomendamos trajes o sacos para los caballeros y vestidos largos para las damas. Les pedimos amablemente que eviten usar blanco, marfil, crema, beige o colores claros similares. Por favor, no tenis.",
      faqs_q3: "¿CUÁNDO DEBO CONFIRMAR MI ASISTENCIA?",
      faqs_a3: "Pedimos que todos los invitados envíen su confirmación a más tardar el 31 de octubre de 2026, para asegurarnos de tener un conteo preciso para nuestros proveedores.",
      faqs_q4: "¿SE PERMITEN ACOMPAÑANTES?",
      faqs_a4: "Debido a las limitaciones de espacio y a la celebración íntima con familia cercana, solo podemos acomodar a quienes figuren en su invitación formal. Por favor consulte su invitación para conocer el número de asientos reservados en su honor. ¡No podemos esperar para celebrar este día especial con nuestros familiares y amigos más cercanos!",
      faqs_q5: "¿CÓMO PUEDO COMPARTIR LAS FOTOS Y VIDEOS QUE TOME?",
      faqs_a5_before: "¡Nos encantaría ver la noche a través de tus ojos! Por favor usa este enlace para agregar tus fotos y videos a nuestro álbum compartido: ",
      faqs_a5_link: "Enlace de Google Photos",
      faqs_q6: "¿CUÁL ES SU HASHTAG DE BODA?",
      faqs_a6: "¡Siéntete libre de usar #MataCorbeira al publicar en redes sociales!",
      faqs_q7: "¿HAY UNA LISTA DE REGALOS?",
      faqs_a7_before: "Si deseas honrarnos con un regalo, puedes encontrar nuestra lista aquí: ",
      faqs_a7_link1: "Lista de bodas en Amazon",
      faqs_a7_middle: ". Para regalos monetarios, también aceptamos Zelle al +1 (954) 918-8129. Por favor consulta la pestaña ",
      faqs_a7_link2: "Regalos",
